<div class="modal ui-modal course-preview" id="course-preview-modal" data-btn-info="<?php esc_html_e('Más información','arkdewp'); ?>" data-btn-buy="<?php esc_html_e('Comprar ahora','arkdewp'); ?>">
  ...
  <div class="modal-content">
		<div class="card">
			...
			<div class="card-content">
				...
				<div class="level is-mobile has-gap-20 mt-5" id="course-preview-price">
