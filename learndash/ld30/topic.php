	...
	<div class="column">
			...
			<?php if ( $video ) : ?>
				<div class="ld-video-wrapper">
					...
					<?php endif; ?>
					<?php if ( $next ) : ?>
						<a href="<?php echo esc_url( $next ); ?>" class="next-topic is-flex is-align-items-center" title="Previous lesson">
				...
				<div class="column is-fulll <?php echo $video ? '' : 'mt-4'; ?>">
					<?php	if ( ! $video ) : ?>
						<div class="is-flex is-align-items-center is-justify-content-space-between mb-5">
							<?php if ( $prev ) : ?>
								<a href="<?php echo esc_url( $prev ); ?>" class="prev-topic is-flex is-align-items-center no-video" title="Previous lesson">
									<i class="fa-solid fa-chevron-left fa-lg mr-2"></i><span class="is-size-7"><?php esc_html_e('Anterior clase','arkdewp')?></span>
								</a>
							<?php endif; ?>
							<?php if ( $next ) : ?>
								<a href="<?php echo esc_url( $next ); ?>" class="next-topic is-flex is-align-items-center no-video" title="Previous lesson">
									<span class="is-size-7  mr-2"><?php esc_html_e('Siguiente clase','arkdewp')?></span><i class="fa-solid fa-chevron-right fa-lg"></i>
								</a>
							<?php endif; ?>
